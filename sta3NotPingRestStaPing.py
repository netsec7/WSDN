...
class CustomTopo:
    def __init__(self):
        ...
        ap1=net.addAccessPoint('ap1', wlans=2, mode='g',ssid= 'ssid-ap1,', position="0,0,0" , range='20,20')


        sta1=net.addStation('sta1', wlans=2, ssid='ssid-sta1,', position='-20,20,0', range='20,20')
        sta2=net.addStation('sta2', wlans=2, ssid='ssid-sta2,', position='-10,20,0', range='20,20')
        sta3=net.addStation('sta3', wlans=2, ssid='ssid-sta3,', position='0,20,0', range='20,20')
        sta4=net.addStation('sta4', wlans=2, ssid='ssid-sta4,', position='10,20,0', range='20,20')
        sta5=net.addStation('sta5', wlans=2, ssid='ssid-sta5,', position='10,60,0', range='20,20')
